...
from ..extensions.apm import apm
from .constants import ALL_METHODS, CREATE, DELETE, GET, HEAD, LIST, PATCH, PUT
from .decorators import (list_loader, param_converter, patch_loader,
                         post_loader, put_loader)
from .docs import MethodResource
from .utils import get_last_param_name


class ModelResource(MethodResource):
    """
    ...
    doc_decorators = {}
    """
    Apply api doc decorators to methods
    """
    ...
    def _get_decorators_for_method(self, method_name, param_name):
        ...
        if method_name == LIST:
            ...
            decorators.append(
                partial(param_converter, **{param_name: self.model}))
        elif method_name in {PATCH, PUT}:
        ...
        if method_name == PATCH:
            decorators.append(
                partial(patch_loader, serializer=self.serializer))
        elif method_name == CREATE:
            decorators.append(
                partial(post_loader, serializer=self.serializer_create))
