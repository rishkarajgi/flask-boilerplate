...
from backend.extensions.docs import docs
...
class Api(BaseApi):
    ...
    def _init_app(self, app):
        ...
        for resource, _, _ in self.resources:
            if issubclass(resource, ModelResource):
                ...
                resource.serializer_create = self.serializers[model_name]\
                    .__class__()
    ...
    def resource(self, *urls, **kwargs):
        ...
        def decorator(cls):
            ...
            docs._deferred.append(
                lambda: docs.register(cls, endpoint=endpoint))
            return cls
        return decorator
    ...
    def add_url_rule(self, rule, endpoint=None, view_func=None, **kwargs):
        ...
        docs._deferred.append(lambda: docs.register(
            view_func, endpoint=endpoint))
    ...
    def _register_view(self, app, resource, *urls, **kwargs):
        ...
        if not issubclass(resource, ModelResource) or 'methods' in kwargs:
            # TODO figure out if docs need to be handled here
        ...
        for url in urls:
            ...
            docs._deferred.append(partial(docs.register, endpoint=endpoint))
